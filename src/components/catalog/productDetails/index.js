            ...
            <div style={{ width: "100%" }}>
              ...
              <div className={styles.prodDetailsDiv}>
                ...
                <div>
                  ...
                  <h3 className={styles.manufacturerDetailData}>
                    Give your body a nutritional boost with the multivitamin and
                    multimineral Zincovit Tablet that is specially formulated to
                    support the overall body functioning. The essential vitamins
                    and minerals support the healthy functioning of the heart,
                    nervous system, immune system, etc. It also has Grape Seed
                    extracts that are loaded with antioxidant properties and
                    help in reducing the cell damage caused by free radicals....
                    READ MORE
                  </h3>
                </div>
              </div>
              ...
              >
                <div style={{ width: "49%" }}>
                  ...
                  <ul>
                    <li>
                      Helps in strengthening immunity system of the body so that
                      it can fight against infections
                    </li>
                    <li>
                    ...
                    <li>
                      Has a balanced nutrional (vitamins and minerals) dose that
              ...
              <div>
                <div>
                  ...
                  <h3 className={styles.manufacturerDetailData}>
                    ...
                    (553(iii)), Grape Seed Extract, Calcium Carbonate (170(i)),
                    Stabilizer (468), Minerals, Binders (1401, 1202, 1201),
                    Silicon Dioxide (551), Disodium EDTA, Permitted Symbiotic
                    Food Colour(214), Coating Agents (901, 462). ..... READ MORE
                  </h3>
                </div>
              </div>
            </div>
